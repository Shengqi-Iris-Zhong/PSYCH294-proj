...
The graph shows that when the student is in low frustration, the variance of their own scores is estimated higher in model 2 than model 1; conversly, a high frustration student is estimated with a higher intrapersonal variance in model 1 than model 2. 
